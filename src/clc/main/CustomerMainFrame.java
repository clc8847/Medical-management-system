...
import clc.frame.SalesMedience;
...
public class CustomerMainFrame extends JFrame {
	...
	public CustomerMainFrame() {
		...
		Label_1.setIcon(new ImageIcon(CustomerMainFrame.class.getResource("/icons/main_01.jpg")));
		panel.add(Label_1);
		...
		JButton button2 = new JButton("\u8D2D\u4E70\u836F\u54C1");
		button2.setForeground(Color.WHITE);
		button2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				mainPanel.removeAll();
				SalesMedience sm = new SalesMedience();
				mainPanel.add(sm);
				mainPanel.updateUI();
			}
		});
		...
		JButton button4 = new JButton("\u5B8C\u5584\u4FE1\u606F");
		...
		button4.setBounds(280, 19, 101, 40);
		panel_1.add(button4);
		
		JButton button = new JButton("\u7CFB\u7EDF\u6CE8\u9500");
		...
		button.setBounds(407, 19, 101, 40);
		panel_1.add(button);
