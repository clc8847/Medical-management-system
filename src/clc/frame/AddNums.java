...
public class AddNums extends JDialog {
	...
	public AddNums(String ID) {
		...
		JLabel label_5 = new JLabel("\u5165\u5E93\u836F\u54C1\u6570\u91CF\uFF1A");
		...
		contentPanel.add(textField1);
		{
			...
			{
				JButton okButton = new JButton("\u786E\u5B9A\u5165\u5E93");
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						if (textField7.equals("")) {
							JOptionPane.showMessageDialog(null, "输入要入库的数量！");
						} else {
							SQLserver s1 = new SQLserver();
							s1.getConnection();
							String num1 = textField7.getText().toString();
							int i1 = s1.updateNum(num1, ID);
							if (i1 == 0) {
